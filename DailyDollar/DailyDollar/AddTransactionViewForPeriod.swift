//
//  AddTransactionViewForPeriod.swift
//  DailyDollar
//
...
struct AddTransactionViewForPeriod: View {
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    DatePicker("Date", selection: $date, in: periodStart...periodEnd, displayedComponents: [.date])
                }
            }
